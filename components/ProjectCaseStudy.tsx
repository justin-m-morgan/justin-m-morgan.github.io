...
const ProjectCaseStudy = ({
    ...
    <section className="px-2 container max-w-8xl mt-12 mx-auto flex flex-col md:grid md:grid-cols-2 gap-8 items-center">
        <div>
            <h1 className="text-5xl md:text-8xl font-bold text-center mt-24 pb-12">{name}</h1>
        ...
        <p className="text-xl leading-relaxed md:leading-loose">{description}</p>
